 ...
 * @date 2025-03-07
 */
public class MyFtpClientRelease {

    private static FTPClient ftpClient = null;

    private static final String endPoint = "172.18.1.131";
    private static final String ak = "pubdataimg";
    private static final String sk = "chenpubdata1234";
